...
```
podman build --volume /media/xubuntu/jesus1/podman/offloaded:/offloaded --arch arm64 -t ghcr.io/malteschoen/paraview-superbuild:arm64 .
```
### testing
```
podman run -it --volume/media/xubuntu/jesus1/podman/offloaded:/offloaded  ghcr.io/malteschoen/paraview-superbuild:arm64 /bin/bash
```
